...
export PYTHONPATH=/data/ModPrompt/src:$PYTHONPATH
export CUDA_VISIBLE_DEVICES=4,5,6,7   # pick your GPUs
...
#   configs/g_dino/FLIR/camel_ir_modprompt_resnet.py \
#   --amp --work-dir output_gdino/camel_ir

torchrun --standalone --nproc_per_node=4 tools/train_gd.py \
  configs/g_dino/FLIR/camel_ir_modprompt_resnet.py \
  --work-dir output_gdino/camel_ir_ddp \
  --amp \
  --launcher pytorch