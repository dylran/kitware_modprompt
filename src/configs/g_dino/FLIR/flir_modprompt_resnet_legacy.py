...
# make sure your custom detector is registered
custom_imports = dict(
    imports=['ground_dino.models'],  # or 'ground_dino.models.detectors.groundin_dino'
...
model = dict(
    ...
    init_cfg=None,   # <-- critical: disable backbone pretrain init
),
    neck=dict(
        type='ChannelMapper',
